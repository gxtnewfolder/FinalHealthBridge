...
namespace FinalHealthBridge.Controllers
{
    public class PrescriptionsController : Controller
    {
        ...
        {
              return _context.Prescription != null ? 
                          View(await _context.Prescription.ToListAsync()) :
        ...
        public async Task<IActionResult> Create([Bind("Id,PatientId,Medication_Name,Dosage")] Prescription prescription)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,PatientId,Medication_Name,Dosage")] Prescription prescription)
        {
